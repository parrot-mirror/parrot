...
writing tests is spent.  Try to write tests which will trigger the warnings in
the package being tested.  They can probably be captured with
Parrot::IO::Capture::Mini; see t/tools/ for examples of how to use this
module.
