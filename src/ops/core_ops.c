...
static op_info_t core_op_info_table[1302] = {
  { /* 0 */
...
INTVAL core_numops = 1301;

/*
** Op Function Table:
*/

static op_func_t core_op_func_table[1302] = {
  Parrot_end,                                        /*      0 */
  Parrot_noop,                                       /*      1 */
  ...
  Parrot_exit_i,                                     /*     60 */
  Parrot_exit_ic,                                    /*     61 */
  Parrot_pushmark_i,                                 /*     62 */
  Parrot_pushmark_ic,                                /*     63 */
  Parrot_popmark_i,                                  /*     64 */
  Parrot_popmark_ic,                                 /*     65 */
  Parrot_pushaction_p,                               /*     66 */
  Parrot_debug_i,                                    /*     67 */
  Parrot_debug_ic,                                   /*     68 */
  Parrot_bounds_i,                                   /*     69 */
  Parrot_bounds_ic,                                  /*     70 */
  ...
  Parrot_band_p_i,                                   /*    124 */
  Parrot_band_p_ic,                                  /*    125 */
  Parrot_band_p_p,                                   /*    126 */
  Parrot_band_i_i_i,                                 /*    127 */
  Parrot_band_i_ic_i,                                /*    128 */
  Parrot_band_i_i_ic,                                /*    129 */
  Parrot_band_p_p_i,                                 /*    130 */
  Parrot_band_p_p_ic,                                /*    131 */
  Parrot_band_p_p_p,                                 /*    132 */
  Parrot_bands_p_s,                                  /*    133 */
  Parrot_bands_p_sc,                                 /*    134 */
  Parrot_bands_p_p,                                  /*    135 */
  Parrot_bands_s_s_s,                                /*    136 */
  Parrot_bands_s_sc_s,                               /*    137 */
  Parrot_bands_s_s_sc,                               /*    138 */
  Parrot_bands_p_p_s,                                /*    139 */
  Parrot_bands_p_p_sc,                               /*    140 */
  Parrot_bands_p_p_p,                                /*    141 */
  Parrot_bnot_i,                                     /*    142 */
  Parrot_bnot_i_i,                                   /*    143 */
  Parrot_bnot_p,                                     /*    144 */
  Parrot_bnot_p_p,                                   /*    145 */
  ...
  Parrot_bxors_p_s,                                  /*    217 */
  Parrot_bxors_p_sc,                                 /*    218 */
  Parrot_bxors_p_p,                                  /*    219 */
  Parrot_bxors_s_s_s,                                /*    220 */
  Parrot_bxors_s_sc_s,                               /*    221 */
  Parrot_bxors_s_s_sc,                               /*    222 */
  Parrot_bxors_p_p_s,                                /*    223 */
  Parrot_bxors_p_p_sc,                               /*    224 */
  Parrot_bxors_p_p_p,                                /*    225 */
  Parrot_eq_i_i_ic,                                  /*    226 */
  Parrot_eq_ic_i_ic,                                 /*    227 */
  Parrot_eq_i_ic_ic,                                 /*    228 */
  Parrot_eq_n_n_ic,                                  /*    229 */
  Parrot_eq_nc_n_ic,                                 /*    230 */
  Parrot_eq_n_nc_ic,                                 /*    231 */
  Parrot_eq_s_s_ic,                                  /*    232 */
  Parrot_eq_sc_s_ic,                                 /*    233 */
  Parrot_eq_s_sc_ic,                                 /*    234 */
  Parrot_eq_p_p_ic,                                  /*    235 */
  Parrot_eq_p_i_ic,                                  /*    236 */
  Parrot_eq_p_ic_ic,                                 /*    237 */
  Parrot_eq_p_n_ic,                                  /*    238 */
  Parrot_eq_p_nc_ic,                                 /*    239 */
  Parrot_eq_p_s_ic,                                  /*    240 */
  Parrot_eq_p_sc_ic,                                 /*    241 */
  Parrot_eq_str_p_p_ic,                              /*    242 */
  Parrot_eq_num_p_p_ic,                              /*    243 */
  Parrot_eq_addr_s_s_ic,                             /*    244 */
  Parrot_eq_addr_sc_s_ic,                            /*    245 */
  Parrot_eq_addr_s_sc_ic,                            /*    246 */
  Parrot_eq_addr_sc_sc_ic,                           /*    247 */
  Parrot_eq_addr_p_p_ic,                             /*    248 */
  Parrot_ne_i_i_ic,                                  /*    249 */
  Parrot_ne_ic_i_ic,                                 /*    250 */
  Parrot_ne_i_ic_ic,                                 /*    251 */
  Parrot_ne_n_n_ic,                                  /*    252 */
  Parrot_ne_nc_n_ic,                                 /*    253 */
  Parrot_ne_n_nc_ic,                                 /*    254 */
  Parrot_ne_s_s_ic,                                  /*    255 */
  Parrot_ne_sc_s_ic,                                 /*    256 */
  Parrot_ne_s_sc_ic,                                 /*    257 */
  Parrot_ne_p_p_ic,                                  /*    258 */
  Parrot_ne_p_i_ic,                                  /*    259 */
  Parrot_ne_p_ic_ic,                                 /*    260 */
  Parrot_ne_p_n_ic,                                  /*    261 */
  Parrot_ne_p_nc_ic,                                 /*    262 */
  Parrot_ne_p_s_ic,                                  /*    263 */
  Parrot_ne_p_sc_ic,                                 /*    264 */
  Parrot_ne_str_p_p_ic,                              /*    265 */
  Parrot_ne_num_p_p_ic,                              /*    266 */
  Parrot_ne_addr_s_s_ic,                             /*    267 */
  Parrot_ne_addr_sc_s_ic,                            /*    268 */
  Parrot_ne_addr_s_sc_ic,                            /*    269 */
  Parrot_ne_addr_sc_sc_ic,                           /*    270 */
  Parrot_ne_addr_p_p_ic,                             /*    271 */
  Parrot_lt_i_i_ic,                                  /*    272 */
  Parrot_lt_ic_i_ic,                                 /*    273 */
  Parrot_lt_i_ic_ic,                                 /*    274 */
  Parrot_lt_n_n_ic,                                  /*    275 */
  Parrot_lt_nc_n_ic,                                 /*    276 */
  Parrot_lt_n_nc_ic,                                 /*    277 */
  Parrot_lt_s_s_ic,                                  /*    278 */
  Parrot_lt_sc_s_ic,                                 /*    279 */
  Parrot_lt_s_sc_ic,                                 /*    280 */
  Parrot_lt_p_p_ic,                                  /*    281 */
  Parrot_lt_p_i_ic,                                  /*    282 */
  Parrot_lt_p_ic_ic,                                 /*    283 */
  Parrot_lt_p_n_ic,                                  /*    284 */
  Parrot_lt_p_nc_ic,                                 /*    285 */
  Parrot_lt_p_s_ic,                                  /*    286 */
  Parrot_lt_p_sc_ic,                                 /*    287 */
  Parrot_lt_str_p_p_ic,                              /*    288 */
  Parrot_lt_num_p_p_ic,                              /*    289 */
  Parrot_le_i_i_ic,                                  /*    290 */
  Parrot_le_ic_i_ic,                                 /*    291 */
  Parrot_le_i_ic_ic,                                 /*    292 */
  Parrot_le_n_n_ic,                                  /*    293 */
  Parrot_le_nc_n_ic,                                 /*    294 */
  Parrot_le_n_nc_ic,                                 /*    295 */
  Parrot_le_s_s_ic,                                  /*    296 */
  Parrot_le_sc_s_ic,                                 /*    297 */
  Parrot_le_s_sc_ic,                                 /*    298 */
  Parrot_le_p_p_ic,                                  /*    299 */
  Parrot_le_p_i_ic,                                  /*    300 */
  Parrot_le_p_ic_ic,                                 /*    301 */
  Parrot_le_p_n_ic,                                  /*    302 */
  Parrot_le_p_nc_ic,                                 /*    303 */
  Parrot_le_p_s_ic,                                  /*    304 */
  Parrot_le_p_sc_ic,                                 /*    305 */
  Parrot_le_str_p_p_ic,                              /*    306 */
  Parrot_le_num_p_p_ic,                              /*    307 */
  Parrot_gt_p_p_ic,                                  /*    308 */
  Parrot_gt_p_i_ic,                                  /*    309 */
  Parrot_gt_p_ic_ic,                                 /*    310 */
  Parrot_gt_p_n_ic,                                  /*    311 */
  Parrot_gt_p_nc_ic,                                 /*    312 */
  Parrot_gt_p_s_ic,                                  /*    313 */
  Parrot_gt_p_sc_ic,                                 /*    314 */
  Parrot_gt_str_p_p_ic,                              /*    315 */
  Parrot_gt_num_p_p_ic,                              /*    316 */
  Parrot_ge_p_p_ic,                                  /*    317 */
  Parrot_ge_p_i_ic,                                  /*    318 */
  Parrot_ge_p_ic_ic,                                 /*    319 */
  Parrot_ge_p_n_ic,                                  /*    320 */
  Parrot_ge_p_nc_ic,                                 /*    321 */
  Parrot_ge_p_s_ic,                                  /*    322 */
  Parrot_ge_p_sc_ic,                                 /*    323 */
  Parrot_ge_str_p_p_ic,                              /*    324 */
  Parrot_ge_num_p_p_ic,                              /*    325 */
  Parrot_if_null_p_ic,                               /*    326 */
  Parrot_if_null_s_ic,                               /*    327 */
  Parrot_unless_null_p_ic,                           /*    328 */
  Parrot_unless_null_s_ic,                           /*    329 */
  Parrot_cmp_i_i_i,                                  /*    330 */
  Parrot_cmp_i_ic_i,                                 /*    331 */
  Parrot_cmp_i_i_ic,                                 /*    332 */
  Parrot_cmp_i_n_n,                                  /*    333 */
  Parrot_cmp_i_nc_n,                                 /*    334 */
  Parrot_cmp_i_n_nc,                                 /*    335 */
  Parrot_cmp_i_s_s,                                  /*    336 */
  Parrot_cmp_i_sc_s,                                 /*    337 */
  Parrot_cmp_i_s_sc,                                 /*    338 */
  Parrot_cmp_i_p_p,                                  /*    339 */
  Parrot_cmp_i_p_i,                                  /*    340 */
  Parrot_cmp_i_p_ic,                                 /*    341 */
  Parrot_cmp_i_p_n,                                  /*    342 */
  Parrot_cmp_i_p_nc,                                 /*    343 */
  Parrot_cmp_i_p_s,                                  /*    344 */
  Parrot_cmp_i_p_sc,                                 /*    345 */
  Parrot_cmp_str_i_p_p,                              /*    346 */
  Parrot_cmp_num_i_p_p,                              /*    347 */
  Parrot_cmp_pmc_p_p_p,                              /*    348 */
  Parrot_issame_i_p_p,                               /*    349 */
  Parrot_issame_i_s_s,                               /*    350 */
  Parrot_issame_i_sc_s,                              /*    351 */
  Parrot_issame_i_s_sc,                              /*    352 */
  Parrot_issame_i_sc_sc,                             /*    353 */
  Parrot_isntsame_i_p_p,                             /*    354 */
  Parrot_isntsame_i_s_s,                             /*    355 */
  Parrot_isntsame_i_sc_s,                            /*    356 */
  Parrot_isntsame_i_s_sc,                            /*    357 */
  Parrot_isntsame_i_sc_sc,                           /*    358 */
  Parrot_istrue_i_p,                                 /*    359 */
  Parrot_isfalse_i_p,                                /*    360 */
  Parrot_isnull_i_p,                                 /*    361 */
  Parrot_isnull_i_pc,                                /*    362 */
  Parrot_isnull_i_s,                                 /*    363 */
  Parrot_isnull_i_sc,                                /*    364 */
  Parrot_isgt_i_p_p,                                 /*    365 */
  Parrot_isge_i_p_p,                                 /*    366 */
  Parrot_isle_i_i_i,                                 /*    367 */
  Parrot_isle_i_ic_i,                                /*    368 */
  Parrot_isle_i_i_ic,                                /*    369 */
  Parrot_isle_i_n_n,                                 /*    370 */
  Parrot_isle_i_nc_n,                                /*    371 */
  Parrot_isle_i_n_nc,                                /*    372 */
  Parrot_isle_i_s_s,                                 /*    373 */
  Parrot_isle_i_sc_s,                                /*    374 */
  Parrot_isle_i_s_sc,                                /*    375 */
  Parrot_isle_i_p_p,                                 /*    376 */
  Parrot_islt_i_i_i,                                 /*    377 */
  Parrot_islt_i_ic_i,                                /*    378 */
  Parrot_islt_i_i_ic,                                /*    379 */
  Parrot_islt_i_n_n,                                 /*    380 */
  Parrot_islt_i_nc_n,                                /*    381 */
  Parrot_islt_i_n_nc,                                /*    382 */
  Parrot_islt_i_s_s,                                 /*    383 */
  Parrot_islt_i_sc_s,                                /*    384 */
  Parrot_islt_i_s_sc,                                /*    385 */
  Parrot_islt_i_p_p,                                 /*    386 */
  Parrot_iseq_i_i_i,                                 /*    387 */
  Parrot_iseq_i_ic_i,                                /*    388 */
  Parrot_iseq_i_i_ic,                                /*    389 */
  Parrot_iseq_i_n_n,                                 /*    390 */
  Parrot_iseq_i_nc_n,                                /*    391 */
  Parrot_iseq_i_n_nc,                                /*    392 */
  Parrot_iseq_i_s_s,                                 /*    393 */
  Parrot_iseq_i_sc_s,                                /*    394 */
  Parrot_iseq_i_s_sc,                                /*    395 */
  Parrot_iseq_i_p_p,                                 /*    396 */
  Parrot_isne_i_i_i,                                 /*    397 */
  Parrot_isne_i_ic_i,                                /*    398 */
  Parrot_isne_i_i_ic,                                /*    399 */
  Parrot_isne_i_n_n,                                 /*    400 */
  Parrot_isne_i_nc_n,                                /*    401 */
  Parrot_isne_i_n_nc,                                /*    402 */
  Parrot_isne_i_s_s,                                 /*    403 */
  Parrot_isne_i_sc_s,                                /*    404 */
  Parrot_isne_i_s_sc,                                /*    405 */
  Parrot_isne_i_p_p,                                 /*    406 */
  Parrot_and_i_i_i,                                  /*    407 */
  Parrot_and_i_ic_i,                                 /*    408 */
  Parrot_and_i_i_ic,                                 /*    409 */
  Parrot_and_p_p_p,                                  /*    410 */
  Parrot_not_i,                                      /*    411 */
  Parrot_not_i_i,                                    /*    412 */
  Parrot_not_p,                                      /*    413 */
  Parrot_not_p_p,                                    /*    414 */
  Parrot_or_i_i_i,                                   /*    415 */
  Parrot_or_i_ic_i,                                  /*    416 */
  Parrot_or_i_i_ic,                                  /*    417 */
  Parrot_or_p_p_p,                                   /*    418 */
  Parrot_xor_i_i_i,                                  /*    419 */
  Parrot_xor_i_ic_i,                                 /*    420 */
  Parrot_xor_i_i_ic,                                 /*    421 */
  Parrot_xor_p_p_p,                                  /*    422 */
  Parrot_debug_init,                                 /*    423 */
  Parrot_debug_load_sc,                              /*    424 */
  Parrot_debug_break,                                /*    425 */
  Parrot_debug_print,                                /*    426 */
  Parrot_backtrace,                                  /*    427 */
  Parrot_getline_i,                                  /*    428 */
  Parrot_getfile_s,                                  /*    429 */
  Parrot_set_label_p_ic,                             /*    430 */
  Parrot_get_label_i_p,                              /*    431 */
  Parrot_close_p,                                    /*    432 */
  ...
  Parrot_chr_s_i,                                    /*    992 */
  Parrot_chr_s_ic,                                   /*    993 */
  Parrot_chopn_s_s_i,                                /*    994 */
  Parrot_chopn_s_sc_i,                               /*    995 */
  Parrot_chopn_s_s_ic,                               /*    996 */
  Parrot_chopn_s_sc_ic,                              /*    997 */
  Parrot_concat_s_s,                                 /*    998 */
  Parrot_concat_s_sc,                                /*    999 */
  Parrot_concat_p_p,                                 /*   1000 */
  Parrot_concat_p_s,                                 /*   1001 */
  Parrot_concat_p_sc,                                /*   1002 */
  Parrot_concat_s_s_s,                               /*   1003 */
  Parrot_concat_s_sc_s,                              /*   1004 */
  Parrot_concat_s_s_sc,                              /*   1005 */
  Parrot_concat_p_p_s,                               /*   1006 */
  Parrot_concat_p_p_sc,                              /*   1007 */
  Parrot_concat_p_p_p,                               /*   1008 */
  Parrot_repeat_s_s_i,                               /*   1009 */
  Parrot_repeat_s_sc_i,                              /*   1010 */
  Parrot_repeat_s_s_ic,                              /*   1011 */
  Parrot_repeat_s_sc_ic,                             /*   1012 */
  Parrot_repeat_p_p_i,                               /*   1013 */
  Parrot_repeat_p_p_ic,                              /*   1014 */
  Parrot_repeat_p_p_p,                               /*   1015 */
  Parrot_repeat_p_i,                                 /*   1016 */
  Parrot_repeat_p_ic,                                /*   1017 */
  Parrot_repeat_p_p,                                 /*   1018 */
  Parrot_length_i_s,                                 /*   1019 */
  Parrot_length_i_sc,                                /*   1020 */
  Parrot_bytelength_i_s,                             /*   1021 */
  Parrot_bytelength_i_sc,                            /*   1022 */
  Parrot_pin_s,                                      /*   1023 */
  Parrot_unpin_s,                                    /*   1024 */
  Parrot_substr_s_s_i,                               /*   1025 */
  Parrot_substr_s_sc_i,                              /*   1026 */
  Parrot_substr_s_s_ic,                              /*   1027 */
  Parrot_substr_s_sc_ic,                             /*   1028 */
  Parrot_substr_s_s_i_i,                             /*   1029 */
  Parrot_substr_s_sc_i_i,                            /*   1030 */
  Parrot_substr_s_s_ic_i,                            /*   1031 */
  Parrot_substr_s_sc_ic_i,                           /*   1032 */
  Parrot_substr_s_s_i_ic,                            /*   1033 */
  Parrot_substr_s_sc_i_ic,                           /*   1034 */
  Parrot_substr_s_s_ic_ic,                           /*   1035 */
  Parrot_substr_s_sc_ic_ic,                          /*   1036 */
  Parrot_substr_s_p_i_i,                             /*   1037 */
  Parrot_substr_s_p_ic_i,                            /*   1038 */
  Parrot_substr_s_p_i_ic,                            /*   1039 */
  Parrot_substr_s_p_ic_ic,                           /*   1040 */
  Parrot_replace_s_s_i_i_s,                          /*   1041 */
  Parrot_replace_s_sc_i_i_s,                         /*   1042 */
  Parrot_replace_s_s_ic_i_s,                         /*   1043 */
  Parrot_replace_s_sc_ic_i_s,                        /*   1044 */
  Parrot_replace_s_s_i_ic_s,                         /*   1045 */
  Parrot_replace_s_sc_i_ic_s,                        /*   1046 */
  Parrot_replace_s_s_ic_ic_s,                        /*   1047 */
  Parrot_replace_s_sc_ic_ic_s,                       /*   1048 */
  Parrot_replace_s_s_i_i_sc,                         /*   1049 */
  Parrot_replace_s_sc_i_i_sc,                        /*   1050 */
  Parrot_replace_s_s_ic_i_sc,                        /*   1051 */
  Parrot_replace_s_sc_ic_i_sc,                       /*   1052 */
  Parrot_replace_s_s_i_ic_sc,                        /*   1053 */
  Parrot_replace_s_sc_i_ic_sc,                       /*   1054 */
  Parrot_replace_s_s_ic_ic_sc,                       /*   1055 */
  Parrot_replace_s_sc_ic_ic_sc,                      /*   1056 */
  Parrot_index_i_s_s,                                /*   1057 */
  Parrot_index_i_sc_s,                               /*   1058 */
  Parrot_index_i_s_sc,                               /*   1059 */
  Parrot_index_i_sc_sc,                              /*   1060 */
  Parrot_index_i_s_s_i,                              /*   1061 */
  Parrot_index_i_sc_s_i,                             /*   1062 */
  Parrot_index_i_s_sc_i,                             /*   1063 */
  Parrot_index_i_sc_sc_i,                            /*   1064 */
  Parrot_index_i_s_s_ic,                             /*   1065 */
  Parrot_index_i_sc_s_ic,                            /*   1066 */
  Parrot_index_i_s_sc_ic,                            /*   1067 */
  Parrot_index_i_sc_sc_ic,                           /*   1068 */
  Parrot_sprintf_s_s_p,                              /*   1069 */
  Parrot_sprintf_s_sc_p,                             /*   1070 */
  Parrot_sprintf_p_p_p,                              /*   1071 */
  Parrot_new_s,                                      /*   1072 */
  Parrot_new_s_i,                                    /*   1073 */
  Parrot_new_s_ic,                                   /*   1074 */
  Parrot_stringinfo_i_s_i,                           /*   1075 */
  Parrot_stringinfo_i_sc_i,                          /*   1076 */
  Parrot_stringinfo_i_s_ic,                          /*   1077 */
  Parrot_stringinfo_i_sc_ic,                         /*   1078 */
  Parrot_upcase_s_s,                                 /*   1079 */
  Parrot_upcase_s_sc,                                /*   1080 */
  Parrot_downcase_s_s,                               /*   1081 */
  Parrot_downcase_s_sc,                              /*   1082 */
  Parrot_titlecase_s_s,                              /*   1083 */
  Parrot_titlecase_s_sc,                             /*   1084 */
  Parrot_join_s_s_p,                                 /*   1085 */
  Parrot_join_s_sc_p,                                /*   1086 */
  Parrot_split_p_s_s,                                /*   1087 */
  Parrot_split_p_sc_s,                               /*   1088 */
  Parrot_split_p_s_sc,                               /*   1089 */
  Parrot_split_p_sc_sc,                              /*   1090 */
  Parrot_charset_i_s,                                /*   1091 */
  Parrot_charset_i_sc,                               /*   1092 */
  Parrot_charsetname_s_i,                            /*   1093 */
  Parrot_charsetname_s_ic,                           /*   1094 */
  Parrot_find_charset_i_s,                           /*   1095 */
  Parrot_find_charset_i_sc,                          /*   1096 */
  Parrot_trans_charset_s_s_i,                        /*   1097 */
  Parrot_trans_charset_s_sc_i,                       /*   1098 */
  Parrot_trans_charset_s_s_ic,                       /*   1099 */
  Parrot_trans_charset_s_sc_ic,                      /*   1100 */
  Parrot_encoding_i_s,                               /*   1101 */
  Parrot_encoding_i_sc,                              /*   1102 */
  Parrot_encodingname_s_i,                           /*   1103 */
  Parrot_encodingname_s_ic,                          /*   1104 */
  Parrot_find_encoding_i_s,                          /*   1105 */
  Parrot_find_encoding_i_sc,                         /*   1106 */
  Parrot_trans_encoding_s_s_i,                       /*   1107 */
  Parrot_trans_encoding_s_sc_i,                      /*   1108 */
  Parrot_trans_encoding_s_s_ic,                      /*   1109 */
  Parrot_trans_encoding_s_sc_ic,                     /*   1110 */
  Parrot_is_cclass_i_i_s_i,                          /*   1111 */
  Parrot_is_cclass_i_ic_s_i,                         /*   1112 */
  Parrot_is_cclass_i_i_sc_i,                         /*   1113 */
  Parrot_is_cclass_i_ic_sc_i,                        /*   1114 */
  Parrot_is_cclass_i_i_s_ic,                         /*   1115 */
  Parrot_is_cclass_i_ic_s_ic,                        /*   1116 */
  Parrot_is_cclass_i_i_sc_ic,                        /*   1117 */
  Parrot_is_cclass_i_ic_sc_ic,                       /*   1118 */
  Parrot_find_cclass_i_i_s_i_i,                      /*   1119 */
  Parrot_find_cclass_i_ic_s_i_i,                     /*   1120 */
  Parrot_find_cclass_i_i_sc_i_i,                     /*   1121 */
  Parrot_find_cclass_i_ic_sc_i_i,                    /*   1122 */
  Parrot_find_cclass_i_i_s_ic_i,                     /*   1123 */
  Parrot_find_cclass_i_ic_s_ic_i,                    /*   1124 */
  Parrot_find_cclass_i_i_sc_ic_i,                    /*   1125 */
  Parrot_find_cclass_i_ic_sc_ic_i,                   /*   1126 */
  Parrot_find_cclass_i_i_s_i_ic,                     /*   1127 */
  Parrot_find_cclass_i_ic_s_i_ic,                    /*   1128 */
  Parrot_find_cclass_i_i_sc_i_ic,                    /*   1129 */
  Parrot_find_cclass_i_ic_sc_i_ic,                   /*   1130 */
  Parrot_find_cclass_i_i_s_ic_ic,                    /*   1131 */
  Parrot_find_cclass_i_ic_s_ic_ic,                   /*   1132 */
  Parrot_find_cclass_i_i_sc_ic_ic,                   /*   1133 */
  Parrot_find_cclass_i_ic_sc_ic_ic,                  /*   1134 */
  Parrot_find_not_cclass_i_i_s_i_i,                  /*   1135 */
  Parrot_find_not_cclass_i_ic_s_i_i,                 /*   1136 */
  Parrot_find_not_cclass_i_i_sc_i_i,                 /*   1137 */
  Parrot_find_not_cclass_i_ic_sc_i_i,                /*   1138 */
  Parrot_find_not_cclass_i_i_s_ic_i,                 /*   1139 */
  Parrot_find_not_cclass_i_ic_s_ic_i,                /*   1140 */
  Parrot_find_not_cclass_i_i_sc_ic_i,                /*   1141 */
  Parrot_find_not_cclass_i_ic_sc_ic_i,               /*   1142 */
  Parrot_find_not_cclass_i_i_s_i_ic,                 /*   1143 */
  Parrot_find_not_cclass_i_ic_s_i_ic,                /*   1144 */
  Parrot_find_not_cclass_i_i_sc_i_ic,                /*   1145 */
  Parrot_find_not_cclass_i_ic_sc_i_ic,               /*   1146 */
  Parrot_find_not_cclass_i_i_s_ic_ic,                /*   1147 */
  Parrot_find_not_cclass_i_ic_s_ic_ic,               /*   1148 */
  Parrot_find_not_cclass_i_i_sc_ic_ic,               /*   1149 */
  Parrot_find_not_cclass_i_ic_sc_ic_ic,              /*   1150 */
  Parrot_escape_s_s,                                 /*   1151 */
  Parrot_compose_s_s,                                /*   1152 */
  Parrot_compose_s_sc,                               /*   1153 */
  Parrot_spawnw_i_s,                                 /*   1154 */
  Parrot_spawnw_i_sc,                                /*   1155 */
  Parrot_spawnw_i_p,                                 /*   1156 */
  Parrot_err_i,                                      /*   1157 */
  Parrot_err_s,                                      /*   1158 */
  Parrot_err_s_i,                                    /*   1159 */
  Parrot_err_s_ic,                                   /*   1160 */
  Parrot_time_i,                                     /*   1161 */
  Parrot_time_n,                                     /*   1162 */
  Parrot_gmtime_s_i,                                 /*   1163 */
  Parrot_gmtime_s_ic,                                /*   1164 */
  Parrot_localtime_s_i,                              /*   1165 */
  Parrot_localtime_s_ic,                             /*   1166 */
  Parrot_decodetime_p_i,                             /*   1167 */
  Parrot_decodetime_p_ic,                            /*   1168 */
  Parrot_decodelocaltime_p_i,                        /*   1169 */
  Parrot_decodelocaltime_p_ic,                       /*   1170 */
  Parrot_sysinfo_s_i,                                /*   1171 */
  Parrot_sysinfo_s_ic,                               /*   1172 */
  Parrot_sysinfo_i_i,                                /*   1173 */
  Parrot_sysinfo_i_ic,                               /*   1174 */
  Parrot_sleep_i,                                    /*   1175 */
  Parrot_sleep_ic,                                   /*   1176 */
  Parrot_sleep_n,                                    /*   1177 */
  Parrot_sleep_nc,                                   /*   1178 */
  Parrot_sizeof_i_i,                                 /*   1179 */
  Parrot_sizeof_i_ic,                                /*   1180 */
  Parrot_store_lex_s_p,                              /*   1181 */
  Parrot_store_lex_sc_p,                             /*   1182 */
  Parrot_store_dynamic_lex_s_p,                      /*   1183 */
  Parrot_store_dynamic_lex_sc_p,                     /*   1184 */
  Parrot_find_lex_p_s,                               /*   1185 */
  Parrot_find_lex_p_sc,                              /*   1186 */
  Parrot_find_dynamic_lex_p_s,                       /*   1187 */
  Parrot_find_dynamic_lex_p_sc,                      /*   1188 */
  Parrot_find_caller_lex_p_s,                        /*   1189 */
  Parrot_find_caller_lex_p_sc,                       /*   1190 */
  Parrot_get_namespace_p,                            /*   1191 */
  Parrot_get_namespace_p_p,                          /*   1192 */
  Parrot_get_namespace_p_pc,                         /*   1193 */
  Parrot_get_hll_namespace_p,                        /*   1194 */
  Parrot_get_hll_namespace_p_p,                      /*   1195 */
  Parrot_get_hll_namespace_p_pc,                     /*   1196 */
  Parrot_get_root_namespace_p,                       /*   1197 */
  Parrot_get_root_namespace_p_p,                     /*   1198 */
  Parrot_get_root_namespace_p_pc,                    /*   1199 */
  Parrot_get_global_p_s,                             /*   1200 */
  Parrot_get_global_p_sc,                            /*   1201 */
  Parrot_get_global_p_p_s,                           /*   1202 */
  Parrot_get_global_p_pc_s,                          /*   1203 */
  Parrot_get_global_p_p_sc,                          /*   1204 */
  Parrot_get_global_p_pc_sc,                         /*   1205 */
  Parrot_get_hll_global_p_s,                         /*   1206 */
  Parrot_get_hll_global_p_sc,                        /*   1207 */
  Parrot_get_hll_global_p_p_s,                       /*   1208 */
  Parrot_get_hll_global_p_pc_s,                      /*   1209 */
  Parrot_get_hll_global_p_p_sc,                      /*   1210 */
  Parrot_get_hll_global_p_pc_sc,                     /*   1211 */
  Parrot_get_root_global_p_s,                        /*   1212 */
  Parrot_get_root_global_p_sc,                       /*   1213 */
  Parrot_get_root_global_p_p_s,                      /*   1214 */
  Parrot_get_root_global_p_pc_s,                     /*   1215 */
  Parrot_get_root_global_p_p_sc,                     /*   1216 */
  Parrot_get_root_global_p_pc_sc,                    /*   1217 */
  Parrot_set_global_s_p,                             /*   1218 */
  Parrot_set_global_sc_p,                            /*   1219 */
  Parrot_set_global_p_s_p,                           /*   1220 */
  Parrot_set_global_pc_s_p,                          /*   1221 */
  Parrot_set_global_p_sc_p,                          /*   1222 */
  Parrot_set_global_pc_sc_p,                         /*   1223 */
  Parrot_set_hll_global_s_p,                         /*   1224 */
  Parrot_set_hll_global_sc_p,                        /*   1225 */
  Parrot_set_hll_global_p_s_p,                       /*   1226 */
  Parrot_set_hll_global_pc_s_p,                      /*   1227 */
  Parrot_set_hll_global_p_sc_p,                      /*   1228 */
  Parrot_set_hll_global_pc_sc_p,                     /*   1229 */
  Parrot_set_root_global_s_p,                        /*   1230 */
  Parrot_set_root_global_sc_p,                       /*   1231 */
  Parrot_set_root_global_p_s_p,                      /*   1232 */
  Parrot_set_root_global_pc_s_p,                     /*   1233 */
  Parrot_set_root_global_p_sc_p,                     /*   1234 */
  Parrot_set_root_global_pc_sc_p,                    /*   1235 */
  Parrot_find_name_p_s,                              /*   1236 */
  Parrot_find_name_p_sc,                             /*   1237 */
  Parrot_find_sub_not_null_p_s,                      /*   1238 */
  Parrot_find_sub_not_null_p_sc,                     /*   1239 */
  Parrot_trap,                                       /*   1240 */
  Parrot_fetch_p_p_p_p,                              /*   1241 */
  Parrot_fetch_p_pc_p_p,                             /*   1242 */
  Parrot_fetch_p_p_pc_p,                             /*   1243 */
  Parrot_fetch_p_pc_pc_p,                            /*   1244 */
  Parrot_fetch_p_p_p_pc,                             /*   1245 */
  Parrot_fetch_p_pc_p_pc,                            /*   1246 */
  Parrot_fetch_p_p_pc_pc,                            /*   1247 */
  Parrot_fetch_p_pc_pc_pc,                           /*   1248 */
  Parrot_fetch_p_p_i_p,                              /*   1249 */
  Parrot_fetch_p_pc_i_p,                             /*   1250 */
  Parrot_fetch_p_p_ic_p,                             /*   1251 */
  Parrot_fetch_p_pc_ic_p,                            /*   1252 */
  Parrot_fetch_p_p_i_pc,                             /*   1253 */
  Parrot_fetch_p_pc_i_pc,                            /*   1254 */
  Parrot_fetch_p_p_ic_pc,                            /*   1255 */
  Parrot_fetch_p_pc_ic_pc,                           /*   1256 */
  Parrot_fetch_p_p_s_p,                              /*   1257 */
  Parrot_fetch_p_pc_s_p,                             /*   1258 */
  Parrot_fetch_p_p_sc_p,                             /*   1259 */
  Parrot_fetch_p_pc_sc_p,                            /*   1260 */
  Parrot_fetch_p_p_s_pc,                             /*   1261 */
  Parrot_fetch_p_pc_s_pc,                            /*   1262 */
  Parrot_fetch_p_p_sc_pc,                            /*   1263 */
  Parrot_fetch_p_pc_sc_pc,                           /*   1264 */
  Parrot_vivify_p_p_p_p,                             /*   1265 */
  Parrot_vivify_p_pc_p_p,                            /*   1266 */
  Parrot_vivify_p_p_pc_p,                            /*   1267 */
  Parrot_vivify_p_pc_pc_p,                           /*   1268 */
  Parrot_vivify_p_p_p_pc,                            /*   1269 */
  Parrot_vivify_p_pc_p_pc,                           /*   1270 */
  Parrot_vivify_p_p_pc_pc,                           /*   1271 */
  Parrot_vivify_p_pc_pc_pc,                          /*   1272 */
  Parrot_vivify_p_p_i_p,                             /*   1273 */
  Parrot_vivify_p_pc_i_p,                            /*   1274 */
  Parrot_vivify_p_p_ic_p,                            /*   1275 */
  Parrot_vivify_p_pc_ic_p,                           /*   1276 */
  Parrot_vivify_p_p_i_pc,                            /*   1277 */
  Parrot_vivify_p_pc_i_pc,                           /*   1278 */
  Parrot_vivify_p_p_ic_pc,                           /*   1279 */
  Parrot_vivify_p_pc_ic_pc,                          /*   1280 */
  Parrot_vivify_p_p_s_p,                             /*   1281 */
  Parrot_vivify_p_pc_s_p,                            /*   1282 */
  Parrot_vivify_p_p_sc_p,                            /*   1283 */
  Parrot_vivify_p_pc_sc_p,                           /*   1284 */
  Parrot_vivify_p_p_s_pc,                            /*   1285 */
  Parrot_vivify_p_pc_s_pc,                           /*   1286 */
  Parrot_vivify_p_p_sc_pc,                           /*   1287 */
  Parrot_vivify_p_pc_sc_pc,                          /*   1288 */
  Parrot_new_p_s_i,                                  /*   1289 */
  Parrot_new_p_sc_i,                                 /*   1290 */
  Parrot_new_p_s_ic,                                 /*   1291 */
  Parrot_new_p_sc_ic,                                /*   1292 */
  Parrot_new_p_p_i,                                  /*   1293 */
  Parrot_new_p_pc_i,                                 /*   1294 */
  Parrot_new_p_p_ic,                                 /*   1295 */
  Parrot_new_p_pc_ic,                                /*   1296 */
  Parrot_root_new_p_p_i,                             /*   1297 */
  Parrot_root_new_p_pc_i,                            /*   1298 */
  Parrot_root_new_p_p_ic,                            /*   1299 */
  Parrot_root_new_p_pc_ic,                           /*   1300 */
