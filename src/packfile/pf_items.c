...
=item C<opcode_t
PF_fetch_opcode(struct Parrot_PackFile *pf, opcode_t **stream)>
...
=item C<INTVAL
PF_fetch_integer(struct Parrot_PackFile *pf, opcode_t **stream)>
...
=item C<FLOATVAL
PF_fetch_number(struct Parrot_PackFile *pf, opcode_t **stream)>
...
=item C<STRING *
PF_fetch_string(Parrot_Interp interp, struct Parrot_PackFile *pf, opcode_t **cursor)>
...
=item C<char *
PF_fetch_cstring(struct Parrot_PackFile *pf, opcode_t **cursor)>
...
=item C<void
PackFile_assign_transforms(struct Parrot_PackFile *pf)>
