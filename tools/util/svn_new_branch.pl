...
use warnings;
use lib ("lib");
use Parrot::VersionControl::Subversion::BranchManager qw( create_new_branch );
...
F<Parrot::VersionControl::Subversion::BranchManager::create_new_branch()> to
...
F<tools/util/svn_synch.pl>.  Parrot::VersionControl::Subversion::BranchManager.
