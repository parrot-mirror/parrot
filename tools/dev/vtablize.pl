...
s/^(\s*)(void set_integer_int\(INTVAL \w*, INTVAL \w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_integer_str\(STRING \*\w*, INTVAL \w*\) {)/$1VTABLE $2/;
...
s/^(\s*)(void set_number_int\(INTVAL \w*, FLOATVAL \w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_number_str\(STRING \*\w*, FLOATVAL \w*\) {)/$1VTABLE $2/;
...
s/^(\s*)(void set_string_int\(INTVAL \w*, STRING \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_string_str\(STRING \*\w*, STRING \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pmc\(PMC \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void assign_pmc\(PMC \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pmc_keyed\(PMC \*\w*, PMC \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pmc_int\(INTVAL \w*, PMC \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pmc_str\(STRING \*\w*, PMC \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pointer\(void \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pointer_keyed\(PMC \*\w*, void \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pointer_int\(INTVAL \w*, void \*\w*\) {)/$1VTABLE $2/;
s/^(\s*)(void set_pointer_str\(STRING \*\w*, void \*\w*\) {)/$1VTABLE $2/;
