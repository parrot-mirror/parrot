...
=item L<http://www.jnthn.net/papers/2006-cam-net2pir-dissertation.pdf>: J.Worthington's Dissertation Paper on net2pbc

=item L<http://en.wikipedia.org/wiki/Common_Language_Infrastructure>: Wikipedia on CLI

=item L<http://www.ecma-international.org/publications/standards/Ecma-335.htm>: "Standard ECMA-335, Common Language Infrastructure (CLI)"

=item L<http://www.iso.org/iso/en/CatalogueDetailPage.CatalogueDetail?CSNUMBER=42927>: "ISO/IEC 23271, Common Language Infrastructure"

=item L<http://www.go-mono.com/>: MONO, the Open Source CLI implementation

=item L<http://www.microsoft.com/downloads/details.aspx?FamilyID=8c09fd61-3f26-4555-ae17-3121b4f51d4d>: Microsoft's Shared Source CLI

=item L<stacktoregister.pod> contains references to SRM (C<Stack to Register Mapping>) issues.
