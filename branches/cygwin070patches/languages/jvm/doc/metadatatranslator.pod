...
The JVM classfile layout is not as complicted as a .NET assembly.
There is a single .class file and a collection of .class files zipped to a 
hierarchy inside a jar file. 
The jar metadata is stored in the META-INF subdirectory, which 
usually contains the MANIFEST.MF file
