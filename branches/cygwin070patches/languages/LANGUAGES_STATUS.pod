...
Much is left to do, but it's complete enough to translate 75% of the .Net class
library.
...
=head2 Java JVM To PIR Translator

=over 4

=item Description

Translates Java JVM .class and .jar files to PIR.

=item Status

Only about 20% of the bytecodes are defined, the pmc's do not work yet. 
This just began with 0.7.0
