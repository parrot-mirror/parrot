...
tools/dev/opsrenumber.pl - Generate Perl module from operation definitions

=head1 SYNOPSIS

 $ perl tools/dev/opsrenumber.pl [--help] [--no-lines] input.ops [input2.ops ...]
 $ perl tools/dev/opsrenumber.pl [--renum]  input.ops [input2.ops ...]
...
Over the years, F<tools/dev/opsrenumber.pl> has been worked on by the following Parrot hackers:
