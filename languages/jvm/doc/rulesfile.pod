...
These specify the translation itself. One of instruction or pir is required
(that is, not both).
...
Multiple lines of pre_translate are allowed.

This is currently only used for enum_fixup for branch, arithmetic/logical
and compare ops.
...
This is the JavaBytecode PMC, used for walking the bytecode. Hopefully, it
